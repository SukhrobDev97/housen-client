...
const Community: NextPage = ({ initialInput, ...props }: T) => {
	...
	/** APOLLO REQUESTS **/
	const [likeTargetBoardArticle] =useMutation(LIKE_TARGET_BOARD_ARTICLE)// Placeholder for like mutation
							...
							<Stack className="left-config">
								<Stack className={'image-info'}>
									...
									<Stack className={'community-name'}>
										<Typography className={'name'}>Housen Community</Typography>
									</Stack>
								</Stack>
									...
									<Stack className="title-box">
										<Stack className="left">
											...
											<Typography className="sub-title">
												Free board for all members to share their thoughts and ideas.
											</Typography>
										</Stack>
										<Button
											onClick={() =>
