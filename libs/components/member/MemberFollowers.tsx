...
const MemberFollowers = (props: MemberFollowsProps) => {
	...
	/** APOLLO REQUESTS **/
	const {
		loading: getMembersFollowersLoading,
		data: getMembersFollowersData,
		error: getMembersFollowersError,
		refetch: getMembersFollowersRefetch,
										...
										{follower.meFollowed && follower.meFollowed[0]?.myFollowing ? (
											<>
												...
												<Button
													...
													onClick={() => unsubscribeHandler(follower?.followerData?._id, getMembersFollowersRefetch, followInquiry)}
												>
													Unfollow
												</Button>
											</>
											...
											<Button
												...
												onClick={() => subscribeHandler(follower?.followerData?._id, getMembersFollowersRefetch, followInquiry)}
											>
												Follow
											</Button>
										)}
